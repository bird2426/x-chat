  ...
  private async cyberFortuneTelling(args: Record<string, any>): Promise<string> {
    ...
    const fortunes = [
      { 
        level: "大吉", 
        title: "灵感满格", 
        desc: "今天适合推进卡住很久的事，直觉会比平时更快找到入口。",
        lucky: "一杯热饮"
      },
      { 
        level: "中吉", 
        title: "稳稳推进", 
        desc: "节奏不必太快，把重要的一步做扎实，就会看到清楚的进展。",
        lucky: "干净的桌面" 
      },
      { 
        level: "小吉", 
        title: "细节回光", 
        desc: "今天的好运藏在小地方，留意那些被忽略的线索和顺手完成的小事。",
        lucky: "常用的笔" 
      },
      { 
        level: "吉", 
        title: "能量回升", 
        desc: "先处理最容易落地的部分，状态会在行动之后慢慢回来。",
        lucky: "清爽的外套" 
      },
      { 
        level: "超吉", 
        title: "高亮时刻", 
        desc: "判断力和执行力都在线，适合做决定、写方案，或把混乱整理成秩序。",
        lucky: "刚整理好的文件" 
      },
      {
        level: "大吉",
        title: "轻装上阵",
        desc: "放下过度预演，按最自然的路径往前走，反而更容易抵达答案。",
        lucky: "一段安静的时间"
      }
    ];
